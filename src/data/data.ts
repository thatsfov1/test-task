...
const companies = [...Array(30)].map(() => ({
    ...
    capital: faker.finance.amount({min: 5000, max: 50000}),
    turnover: faker.finance.amount({min: 200000, max: 1000000}),
    net_profit: faker.finance.amount({min: 20000, max: 100000}),
